<?php
namespace Goran\CeGallery\Domain\Repository;
...
use Goran\CeGallery\Domain\Model\MediaAlbum;
...
class MediaAlbumRepository extends \TYPO3\CMS\Extbase\Persistence\Repository
{
     ...
     * @return \Goran\CeGallery\Domain\Model\MediaAlbum|NULL
     */
    public function findRandom($parent = null)
    {
        ...
        /** @var \Goran\CeGallery\Domain\Model\MediaAlbum $mediaAlbum */
    ...
    public function findByUid($uid, $respectStorage = true)
    {
        ...
        /** @var $mediaAlbum \Goran\CeGallery\Domain\Model\MediaAlbum */
     ...
     * @param string $orderBy Sort albums by: crdate|sorting
     * @param string $orderDirection Sort order: asc|desc
     * @return MediaAlbum[]
     */
    public function findAll($excludeEmptyAlbums = true, $orderBy = 'crdate', $orderDirection = 'desc')
    {
